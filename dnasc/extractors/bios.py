...
class BIOSExtractor:
    ...
    def get_bios_workorders() -> pd.DataFrame:
        ...
        SELECT
            ...
            TRIM(COALESCE(ssw.vendor_order_id, psw.vendor_order_id, osw.vendor_order_id)) AS vendor_order_id,
        ...
        SELECT
            ...
            NULL AS vendor, NULL AS vendor_order_id, NULL AS untracked_description,
